...
export const hi: Record<string, string> = {
  ...
  aiComplete: 'AI पूर्णता',
  aiDefaultInstruction: 'इस कोड को पूरा करें',
  aiInsert: 'सम्मिलित करें',
  aiInstructionPlaceholder: 'निर्देश लिखें (जैसे: पूरा करें / समझाएँ / रीफ़ैक्टर करें)',
  aiPlaceholder: 'इस कोड को पूरा करें / आगे बढ़ाएँ / समझाएँ',
  aiReplace: 'बदलें',
  aiRun: 'बनाएँ',
  aiRunning: 'बनाया जा रहा है…',
  dock: 'साइडबार में वापस लगाएँ',
  floating: 'तैरती विंडो',
  floatingGrip: '⠿ खींचकर हिलाएँ, कोने से आकार बदलें',
  gotoLinePrompt: 'इस पंक्ति पर जाएँ:',
  moveSide: 'डॉक की दिशा बदलें',
  outline: 'रूपरेखा',
  outlineEmpty: 'इस फ़ाइल में कोई प्रतीक नहीं है',
  settingsEditorAutoSaveDesc: 'मान: off (केवल Ctrl+S से मैन्युअल), onBlur (एडिटर से फ़ोकस हटने पर सहेजें), afterDelay (टाइपिंग रुकने के लगभग 1 सेकंड बाद सहेजें)',
  settingsEditorAutoSavePlaceholder: 'off / onBlur / afterDelay',
  settingsEditorAutoSaveTitle: 'स्वतः सहेजना',
  settingsEditorFontFamilyDesc: 'एडिटर का कस्टम फ़ॉन्ट परिवार (CSS font-family स्टैक, जैसे "JetBrains Mono", monospace; खाली छोड़ने पर थीम का मोनोस्पेस फ़ॉन्ट)',
  settingsEditorFontFamilyPlaceholder: '"JetBrains Mono", monospace',
  settingsEditorFontFamilyTitle: 'एडिटर फ़ॉन्ट',
  settingsEditorFontSizeDesc: 'एडिटर का फ़ॉन्ट आकार px में (10–32, डिफ़ॉल्ट 13)',
  settingsEditorFontSizeSuffix: 'px',
  settingsEditorFontSizeTitle: 'एडिटर फ़ॉन्ट आकार',
  settingsEditorLineNumbersDesc: 'एडिटर के बाईं ओर पंक्ति-संख्या पट्टी दिखाएँ (डिफ़ॉल्ट रूप से चालू)',
  settingsEditorLineNumbersTitle: 'पंक्ति संख्याएँ दिखाएँ',
  settingsEditorTabSizeDesc: 'एडिटर में Tab कुंजी से जुड़ने वाले स्पेस की संख्या (2–8, डिफ़ॉल्ट 4)',
  settingsEditorTabSizeSuffix: 'स्पेस',
  settingsEditorTabSizeTitle: 'Tab चौड़ाई',
  settingsEditorWordWrapDesc: 'एडिटर की चौड़ाई से लंबी पंक्तियों को रैप करें (डिफ़ॉल्ट रूप से चालू)',
  settingsEditorWordWrapTitle: 'शब्द रैप',
}
