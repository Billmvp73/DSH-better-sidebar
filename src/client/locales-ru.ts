...
export const ru: Record<string, string> = {
  ...
  aiComplete: 'Дополнение ИИ',
  aiDefaultInstruction: 'Дополнить этот код',
  aiInsert: 'Вставить',
  aiInstructionPlaceholder: 'Введите инструкцию (напр.: дополнить / объяснить / отрефакторить)',
  aiPlaceholder: 'Дополнить / продолжить / объяснить этот код',
  aiReplace: 'Заменить',
  aiRun: 'Сгенерировать',
  aiRunning: 'Генерация…',
  dock: 'Вернуть на боковую панель',
  floating: 'Плавающее окно',
  floatingGrip: '⠿ перетащите, чтобы переместить; размер — за угол',
  gotoLinePrompt: 'Перейти к строке:',
  moveSide: 'Сменить сторону закрепления',
  outline: 'Структура',
  outlineEmpty: 'В этом файле нет символов',
  settingsEditorAutoSaveDesc: 'Значения: off (только вручную по Ctrl+S), onBlur (сохранять при потере фокуса редактором), afterDelay (сохранять примерно через 1 с после остановки ввода)',
  settingsEditorAutoSavePlaceholder: 'off / onBlur / afterDelay',
  settingsEditorAutoSaveTitle: 'Автосохранение',
  settingsEditorFontFamilyDesc: 'Собственное семейство шрифтов редактора (стек CSS font-family, напр. "JetBrains Mono", monospace; пусто — использовать моноширинный шрифт темы)',
  settingsEditorFontFamilyPlaceholder: '"JetBrains Mono", monospace',
  settingsEditorFontFamilyTitle: 'Шрифт редактора',
  settingsEditorFontSizeDesc: 'Размер шрифта редактора в px (10–32, по умолчанию 13)',
  settingsEditorFontSizeSuffix: 'px',
  settingsEditorFontSizeTitle: 'Размер шрифта редактора',
  settingsEditorLineNumbersDesc: 'Показывать полосу номеров строк слева от редактора (включено по умолчанию)',
  settingsEditorLineNumbersTitle: 'Показывать номера строк',
  settingsEditorTabSizeDesc: 'Число пробелов, вставляемых клавишей Tab в редакторе (2–8, по умолчанию 4)',
  settingsEditorTabSizeSuffix: 'пробелов',
  settingsEditorTabSizeTitle: 'Ширина табуляции',
  settingsEditorWordWrapDesc: 'Переносить длинные строки, выходящие за ширину редактора (включено по умолчанию)',
  settingsEditorWordWrapTitle: 'Перенос строк',
}
