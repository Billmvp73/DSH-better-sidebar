...
export const it: Record<string, string> = {
  ...
  aiComplete: 'Completamento IA',
  aiDefaultInstruction: 'Completa questo codice',
  aiInsert: 'Inserisci',
  aiInstructionPlaceholder: 'Scrivi un\'istruzione (es. completa / spiega / rifattorizza)',
  aiPlaceholder: 'Completa / prosegui / spiega questo codice',
  aiReplace: 'Sostituisci',
  aiRun: 'Genera',
  aiRunning: 'Generazione…',
  dock: 'Riaggancia alla barra laterale',
  floating: 'Finestra mobile',
  floatingGrip: '⠿ trascina per spostare, ridimensiona dall\'angolo',
  gotoLinePrompt: 'Vai alla riga:',
  moveSide: 'Cambia lato di aggancio',
  outline: 'Struttura',
  outlineEmpty: 'Nessun simbolo in questo file',
  settingsEditorAutoSaveDesc: 'Valori: off (solo manuale con Ctrl+S), onBlur (salva quando l\'editor perde il focus), afterDelay (salva circa 1 s dopo aver smesso di digitare)',
  settingsEditorAutoSavePlaceholder: 'off / onBlur / afterDelay',
  settingsEditorAutoSaveTitle: 'Salvataggio automatico',
  settingsEditorFontFamilyDesc: 'Famiglia di caratteri personalizzata dell\'editor (stack CSS font-family come "JetBrains Mono", monospace; lascia vuoto per seguire il carattere monospazio del tema)',
  settingsEditorFontFamilyPlaceholder: '"JetBrains Mono", monospace',
  settingsEditorFontFamilyTitle: 'Carattere dell\'editor',
  settingsEditorFontSizeDesc: 'Dimensione del carattere dell\'editor in px (10–32, predefinito 13)',
  settingsEditorFontSizeSuffix: 'px',
  settingsEditorFontSizeTitle: 'Dimensione carattere dell\'editor',
  settingsEditorLineNumbersDesc: 'Mostra la barra dei numeri di riga a sinistra dell\'editor (attivo per impostazione predefinita)',
  settingsEditorLineNumbersTitle: 'Mostra i numeri di riga',
  settingsEditorTabSizeDesc: 'Numero di spazi inseriti dal tasto Tab nell\'editor (2–8, predefinito 4)',
  settingsEditorTabSizeSuffix: 'spazi',
  settingsEditorTabSizeTitle: 'Larghezza tabulazione',
  settingsEditorWordWrapDesc: 'Manda a capo le righe lunghe che superano la larghezza dell\'editor (attivo per impostazione predefinita)',
  settingsEditorWordWrapTitle: 'A capo automatico',
}
