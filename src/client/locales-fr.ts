...
export const fr: Record<string, string> = {
  ...
  aiDefaultInstruction: 'Compléter ce code',
  aiInsert: 'Insérer',
  aiInstructionPlaceholder: 'Saisissez une instruction (par ex. compléter / expliquer / refactoriser)',
  aiPlaceholder: 'Compléter / poursuivre / expliquer ce code',
  aiReplace: 'Remplacer',
  aiRun: 'Générer',
  aiRunning: 'Génération…',
  dock: 'Réancrer à la barre latérale',
  floating: 'Fenêtre flottante',
  floatingGrip: '⠿ glisser pour déplacer, redimensionner par le coin',
  gotoLinePrompt: 'Aller à la ligne :',
  moveSide: 'Changer de côté d\'ancrage',
  outline: 'Plan',
  outlineEmpty: 'Aucun symbole dans ce fichier',
  settingsEditorAutoSaveDesc: 'Valeurs : off (Ctrl+S manuel uniquement), onBlur (enregistrer quand l\'éditeur perd le focus), afterDelay (enregistrer environ 1 s après la fin de la saisie)',
  settingsEditorAutoSavePlaceholder: 'off / onBlur / afterDelay',
  settingsEditorAutoSaveTitle: 'Enregistrement automatique',
  settingsEditorFontFamilyDesc: 'Famille de polices personnalisée de l\'éditeur (pile CSS font-family telle que "JetBrains Mono", monospace ; laisser vide pour suivre la police à chasse fixe du thème)',
  settingsEditorFontFamilyPlaceholder: '"JetBrains Mono", monospace',
  settingsEditorFontFamilyTitle: 'Police de l\'éditeur',
  settingsEditorFontSizeDesc: 'Taille de police de l\'éditeur en px (10–32, par défaut 13)',
  settingsEditorFontSizeSuffix: 'px',
  settingsEditorFontSizeTitle: 'Taille de police de l\'éditeur',
  settingsEditorLineNumbersDesc: 'Afficher la gouttière des numéros de ligne à gauche de l\'éditeur (activé par défaut)',
  settingsEditorLineNumbersTitle: 'Afficher les numéros de ligne',
  settingsEditorTabSizeDesc: 'Nombre d\'espaces insérés par la touche Tab dans l\'éditeur (2–8, par défaut 4)',
  settingsEditorTabSizeSuffix: 'espaces',
  settingsEditorTabSizeTitle: 'Largeur de tabulation',
  settingsEditorWordWrapDesc: 'Renvoyer à la ligne les lignes dépassant la largeur de l\'éditeur (activé par défaut)',
  settingsEditorWordWrapTitle: 'Retour à la ligne',
}
