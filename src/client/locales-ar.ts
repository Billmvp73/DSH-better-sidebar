...
export const ar: Record<string, string> = {
  ...
  aiComplete: 'إكمال بالذكاء الاصطناعي',
  aiDefaultInstruction: 'أكمل هذا الكود',
  aiInsert: 'إدراج',
  aiInstructionPlaceholder: 'اكتب تعليمة (مثل: إكمال / شرح / إعادة هيكلة)',
  aiPlaceholder: 'إكمال / متابعة / شرح هذا الكود',
  aiReplace: 'استبدال',
  aiRun: 'توليد',
  aiRunning: 'جارٍ التوليد…',
  dock: 'إرساء إلى الشريط الجانبي',
  floating: 'نافذة عائمة',
  floatingGrip: '⠿ اسحب للتحريك، غيّر الحجم من الزاوية',
  gotoLinePrompt: 'الانتقال إلى السطر:',
  moveSide: 'تبديل جهة الإرساء',
  outline: 'المخطط',
  outlineEmpty: 'لا توجد رموز في هذا الملف',
  settingsEditorAutoSaveDesc: 'القيم: off (يدويًا عبر Ctrl+S فقط)، onBlur (الحفظ عند فقدان المحرر للتركيز)، afterDelay (الحفظ بعد نحو ثانية من التوقف عن الكتابة)',
  settingsEditorAutoSavePlaceholder: 'off / onBlur / afterDelay',
  settingsEditorAutoSaveTitle: 'الحفظ التلقائي',
  settingsEditorFontFamilyDesc: 'عائلة خطوط مخصصة للمحرر (سلسلة CSS font-family مثل "JetBrains Mono", monospace؛ اتركه فارغًا لاتباع الخط أحادي المسافة للسمة)',
  settingsEditorFontFamilyPlaceholder: '"JetBrains Mono", monospace',
  settingsEditorFontFamilyTitle: 'خط المحرر',
  settingsEditorFontSizeDesc: 'حجم خط المحرر بالبكسل (10–32، الافتراضي 13)',
  settingsEditorFontSizeSuffix: 'px',
  settingsEditorFontSizeTitle: 'حجم خط المحرر',
  settingsEditorLineNumbersDesc: 'إظهار شريط أرقام الأسطر على يسار المحرر (مفعّل افتراضيًا)',
  settingsEditorLineNumbersTitle: 'إظهار أرقام الأسطر',
  settingsEditorTabSizeDesc: 'عدد المسافات التي يدرجها مفتاح Tab في المحرر (2–8، الافتراضي 4)',
  settingsEditorTabSizeSuffix: 'مسافات',
  settingsEditorTabSizeTitle: 'عرض Tab',
  settingsEditorWordWrapDesc: 'التفاف الأسطر الطويلة التي تتجاوز عرض المحرر (مفعّل افتراضيًا)',
  settingsEditorWordWrapTitle: 'التفاف النص',
}
