...
export const ko: Record<string, string> = {
  ...
  aiComplete: 'AI 자동 완성',
  aiDefaultInstruction: '이 코드를 완성하기',
  aiInsert: '삽입',
  aiInstructionPlaceholder: '지시를 입력하세요 (예: 완성 / 설명 / 리팩터링)',
  aiPlaceholder: '이 코드를 완성 / 이어쓰기 / 설명',
  aiReplace: '바꾸기',
  aiRun: '생성',
  aiRunning: '생성 중…',
  dock: '사이드바로 다시 도킹',
  floating: '플로팅 창',
  floatingGrip: '⠿ 끌어서 이동, 모서리에서 크기 조절',
  gotoLinePrompt: '이동할 줄 번호:',
  moveSide: '도킹 위치 전환',
  outline: '개요',
  outlineEmpty: '이 파일에 표시할 기호가 없습니다',
  settingsEditorAutoSaveDesc: '값: off(Ctrl+S 수동 저장만), onBlur(편집기가 포커스를 잃을 때 저장), afterDelay(입력을 멈춘 뒤 약 1초 후 저장)',
  settingsEditorAutoSavePlaceholder: 'off / onBlur / afterDelay',
  settingsEditorAutoSaveTitle: '자동 저장',
  settingsEditorFontFamilyDesc: '편집기 글꼴 모음 지정 (CSS font-family 스택, 예: "JetBrains Mono", monospace. 비워 두면 테마의 고정폭 글꼴을 따릅니다)',
  settingsEditorFontFamilyPlaceholder: '"JetBrains Mono", monospace',
  settingsEditorFontFamilyTitle: '편집기 글꼴',
  settingsEditorFontSizeDesc: '편집기 글꼴 크기(px) (10–32, 기본값 13)',
  settingsEditorFontSizeSuffix: 'px',
  settingsEditorFontSizeTitle: '편집기 글꼴 크기',
  settingsEditorLineNumbersDesc: '편집기 왼쪽에 줄 번호 여백을 표시합니다 (기본값 켜짐)',
  settingsEditorLineNumbersTitle: '줄 번호 표시',
  settingsEditorTabSizeDesc: '편집기에서 Tab 키가 삽입하는 공백 수 (2–8, 기본값 4)',
  settingsEditorTabSizeSuffix: '칸',
  settingsEditorTabSizeTitle: 'Tab 너비',
  settingsEditorWordWrapDesc: '편집기 너비를 넘는 긴 줄을 자동으로 줄바꿈합니다 (기본값 켜짐)',
  settingsEditorWordWrapTitle: '자동 줄바꿈',
}
