...
export const nl: Record<string, string> = {
  ...
  aiComplete: 'AI-aanvulling',
  aiDefaultInstruction: 'Deze code aanvullen',
  aiInsert: 'Invoegen',
  aiInstructionPlaceholder: 'Typ een instructie (bijv. aanvullen / uitleggen / herstructureren)',
  aiPlaceholder: 'Deze code aanvullen / voortzetten / uitleggen',
  aiReplace: 'Vervangen',
  aiRun: 'Genereren',
  aiRunning: 'Bezig met genereren…',
  dock: 'Terugkoppelen aan de zijbalk',
  floating: 'Zwevend venster',
  floatingGrip: '⠿ sleep om te verplaatsen, formaat wijzigen via de hoek',
  gotoLinePrompt: 'Ga naar regel:',
  moveSide: 'Koppelzijde wisselen',
  outline: 'Overzicht',
  outlineEmpty: 'Geen symbolen in dit bestand',
  settingsEditorAutoSaveDesc: 'Waarden: off (alleen handmatig met Ctrl+S), onBlur (opslaan wanneer de editor de focus verliest), afterDelay (ongeveer 1 s na het laatste typen opslaan)',
  settingsEditorAutoSavePlaceholder: 'off / onBlur / afterDelay',
  settingsEditorAutoSaveTitle: 'Automatisch opslaan',
  settingsEditorFontFamilyDesc: 'Eigen lettertypefamilie van de editor (CSS-font-family-stack zoals "JetBrains Mono", monospace; laat leeg om het monospace-lettertype van het thema te volgen)',
  settingsEditorFontFamilyPlaceholder: '"JetBrains Mono", monospace',
  settingsEditorFontFamilyTitle: 'Editorlettertype',
  settingsEditorFontSizeDesc: 'Lettergrootte van de editor in px (10–32, standaard 13)',
  settingsEditorFontSizeSuffix: 'px',
  settingsEditorFontSizeTitle: 'Editorlettergrootte',
  settingsEditorLineNumbersDesc: 'Toon de regelnummerbalk links in de editor (standaard aan)',
  settingsEditorLineNumbersTitle: 'Regelnummers tonen',
  settingsEditorTabSizeDesc: 'Aantal spaties dat de Tab-toets in de editor invoegt (2–8, standaard 4)',
  settingsEditorTabSizeSuffix: 'spaties',
  settingsEditorTabSizeTitle: 'Tabbreedte',
  settingsEditorWordWrapDesc: 'Lange regels die breder zijn dan de editor laten teruglopen (standaard aan)',
  settingsEditorWordWrapTitle: 'Regelterugloop',
}
