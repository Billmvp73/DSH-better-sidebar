...
export const tr: Record<string, string> = {
  ...
  aiComplete: 'AI tamamlama',
  aiDefaultInstruction: 'Bu kodu tamamla',
  aiInsert: 'Ekle',
  aiInstructionPlaceholder: 'Bir yönerge yazın (ör. tamamla / açıkla / yeniden düzenle)',
  aiPlaceholder: 'Bu kodu tamamla / sürdür / açıkla',
  aiReplace: 'Değiştir',
  aiRun: 'Oluştur',
  aiRunning: 'Oluşturuluyor…',
  dock: 'Kenar çubuğuna geri yerleştir',
  floating: 'Yüzen pencere',
  floatingGrip: '⠿ taşımak için sürükleyin, köşeden boyutlandırın',
  gotoLinePrompt: 'Şu satıra git:',
  moveSide: 'Yerleşim tarafını değiştir',
  outline: 'Ana hat',
  outlineEmpty: 'Bu dosyada gösterilecek simge yok',
  settingsEditorAutoSaveDesc: 'Değerler: off (yalnızca Ctrl+S ile elle), onBlur (düzenleyici odağı kaybettiğinde kaydet), afterDelay (yazmayı bıraktıktan yaklaşık 1 sn sonra kaydet)',
  settingsEditorAutoSavePlaceholder: 'off / onBlur / afterDelay',
  settingsEditorAutoSaveTitle: 'Otomatik kaydetme',
  settingsEditorFontFamilyDesc: 'Düzenleyici için özel yazı tipi ailesi (CSS font-family yığını, ör. "JetBrains Mono", monospace; boş bırakılırsa temanın eş aralıklı yazı tipi kullanılır)',
  settingsEditorFontFamilyPlaceholder: '"JetBrains Mono", monospace',
  settingsEditorFontFamilyTitle: 'Düzenleyici yazı tipi',
  settingsEditorFontSizeDesc: 'Düzenleyicinin px cinsinden yazı boyutu (10–32, varsayılan 13)',
  settingsEditorFontSizeSuffix: 'px',
  settingsEditorFontSizeTitle: 'Düzenleyici yazı boyutu',
  settingsEditorLineNumbersDesc: 'Düzenleyicinin solunda satır numarası cetvelini göster (varsayılan açık)',
  settingsEditorLineNumbersTitle: 'Satır numaralarını göster',
  settingsEditorTabSizeDesc: 'Düzenleyicide Tab tuşunun eklediği boşluk sayısı (2–8, varsayılan 4)',
  settingsEditorTabSizeSuffix: 'boşluk',
  settingsEditorTabSizeTitle: 'Tab genişliği',
  settingsEditorWordWrapDesc: 'Düzenleyici genişliğini aşan uzun satırları kaydır (varsayılan açık)',
  settingsEditorWordWrapTitle: 'Sözcük kaydırma',
}
