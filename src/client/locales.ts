...
export const zh = {
  ...
  floating: '浮动窗口',
  dock: '停靠回侧边栏',
  floatingGrip: '⠿ 拖动移动，右下角调整大小',
  moveSide: '切换停靠侧',
  gotoLinePrompt: '跳转到行号：',
  ...
  saveFailed: '保存失败',
  outline: '大纲',
  outlineEmpty: '此文件没有可显示的符号',
  aiComplete: 'AI 补全',
  aiPlaceholder: '补全 / 续写 / 解释这段代码',
  aiDefaultInstruction: '补全这段代码',
  aiInstructionPlaceholder: '输入指令，如：补全 / 解释 / 重构这段代码',
  aiRun: '生成',
  aiRunning: '生成中…',
  aiInsert: '插入',
  aiReplace: '替换',
  ...
  settingsEditorFontFamilyTitle: '编辑器字体',
  settingsEditorFontFamilyDesc: '自定义编辑器字体族（CSS font-family，如 "JetBrains Mono", monospace；留空跟随主题等宽字体）',
  settingsEditorFontFamilyPlaceholder: '"JetBrains Mono", monospace',
  settingsEditorFontSizeTitle: '编辑器字号',
  settingsEditorFontSizeDesc: '编辑器字号（10–32，默认 13）',
  settingsEditorFontSizeSuffix: 'px',
  settingsEditorTabSizeTitle: 'Tab 宽度',
  settingsEditorTabSizeDesc: '编辑器 Tab 键缩进的空格数（2–8，默认 4）',
  settingsEditorTabSizeSuffix: '空格',
  settingsEditorWordWrapTitle: '自动换行',
  settingsEditorWordWrapDesc: '开启后，超出编辑器宽度的长行自动换行显示（默认开启）',
  settingsEditorLineNumbersTitle: '显示行号',
  settingsEditorLineNumbersDesc: '在编辑器左侧显示行号栏（默认开启）',
  settingsEditorAutoSaveTitle: '自动保存',
  settingsEditorAutoSaveDesc: '可选值：off（仅手动 Ctrl+S）、onBlur（编辑器失焦时保存）、afterDelay（停止输入约 1 秒后保存）',
  settingsEditorAutoSavePlaceholder: 'off / onBlur / afterDelay',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  dock: 'Dock back to sidebar',
  floatingGrip: '⠿ drag to move, resize from corner',
  moveSide: 'Switch dock side',
  ...
  outline: 'Outline',
  outlineEmpty: 'No symbols in this file',
  aiComplete: 'AI Completion',
  aiPlaceholder: 'Complete / continue / explain this code',
  aiDefaultInstruction: 'Complete this code',
  aiInstructionPlaceholder: 'Type an instruction (e.g. complete / explain / refactor)',
  aiRun: 'Generate',
  ...
  settingsFontSizeSuffix: 'px',
  settingsEditorFontFamilyTitle: 'Editor font family',
  settingsEditorFontFamilyDesc: 'Custom editor font family (a CSS font-family stack like "JetBrains Mono", monospace; leave empty to follow the theme\'s monospace font)',
  settingsEditorFontFamilyPlaceholder: '"JetBrains Mono", monospace',
  settingsEditorFontSizeTitle: 'Editor font size',
  settingsEditorFontSizeDesc: 'Editor font size in px (10–32, default 13)',
  settingsEditorFontSizeSuffix: 'px',
  settingsEditorTabSizeTitle: 'Tab width',
  settingsEditorTabSizeDesc: 'Number of spaces a Tab key inserts in the editor (2–8, default 4)',
  settingsEditorTabSizeSuffix: 'spaces',
  settingsEditorWordWrapTitle: 'Word wrap',
  settingsEditorWordWrapDesc: 'Wrap long lines that exceed the editor width (on by default)',
  settingsEditorLineNumbersTitle: 'Show line numbers',
  settingsEditorLineNumbersDesc: 'Show a line-number gutter on the left of the editor (on by default)',
  settingsEditorAutoSaveTitle: 'Auto save',
  settingsEditorAutoSaveDesc: 'Values: off (manual Ctrl+S only), onBlur (save when the editor loses focus), afterDelay (save ~1s after you stop typing)',
  settingsEditorAutoSavePlaceholder: 'off / onBlur / afterDelay',
