export const sv: Record<string, string> = {
  ...
  aiComplete: 'AI-komplettering',
  aiDefaultInstruction: 'Komplettera den här koden',
  aiInsert: 'Infoga',
  aiInstructionPlaceholder: 'Skriv en instruktion (t.ex. komplettera / förklara / refaktorisera)',
  aiPlaceholder: 'Komplettera / fortsätt / förklara den här koden',
  aiReplace: 'Ersätt',
  aiRun: 'Generera',
  aiRunning: 'Genererar…',
  dock: 'Docka tillbaka till sidopanelen',
  floating: 'Flytande fönster',
  floatingGrip: '⠿ dra för att flytta, ändra storlek i hörnet',
  gotoLinePrompt: 'Gå till rad:',
  moveSide: 'Byt dockningssida',
  outline: 'Översikt',
  outlineEmpty: 'Inga symboler i den här filen',
  settingsEditorAutoSaveDesc: 'Värden: off (endast manuellt med Ctrl+S), onBlur (spara när redigeraren tappar fokus), afterDelay (spara cirka 1 s efter att du slutat skriva)',
  settingsEditorAutoSavePlaceholder: 'off / onBlur / afterDelay',
  settingsEditorAutoSaveTitle: 'Spara automatiskt',
  settingsEditorFontFamilyDesc: 'Eget teckensnitt för redigeraren (CSS-font-family-stack som "JetBrains Mono", monospace; lämna tomt för att följa temats monospace-teckensnitt)',
  settingsEditorFontFamilyPlaceholder: '"JetBrains Mono", monospace',
  settingsEditorFontFamilyTitle: 'Redigerarens teckensnitt',
  settingsEditorFontSizeDesc: 'Redigerarens teckenstorlek i px (10–32, standard 13)',
  settingsEditorFontSizeSuffix: 'px',
  settingsEditorFontSizeTitle: 'Redigerarens teckenstorlek',
  settingsEditorLineNumbersDesc: 'Visa radnummerlisten till vänster i redigeraren (på som standard)',
  settingsEditorLineNumbersTitle: 'Visa radnummer',
  settingsEditorTabSizeDesc: 'Antal blanksteg som Tab-tangenten infogar i redigeraren (2–8, standard 4)',
  settingsEditorTabSizeSuffix: 'blanksteg',
  settingsEditorTabSizeTitle: 'Tabbredd',
  settingsEditorWordWrapDesc: 'Bryt långa rader som överskrider redigerarens bredd (på som standard)',
  settingsEditorWordWrapTitle: 'Radbrytning',
}
