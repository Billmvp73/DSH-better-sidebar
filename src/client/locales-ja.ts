...
export const ja: Record<string, string> = {
  ...
  aiComplete: 'AI 補完',
  aiDefaultInstruction: 'このコードを補完する',
  aiInsert: '挿入',
  aiInstructionPlaceholder: '指示を入力（例：補完 / 説明 / リファクタリング）',
  aiPlaceholder: 'このコードを補完 / 続き / 説明',
  aiReplace: '置換',
  aiRun: '生成',
  aiRunning: '生成中…',
  dock: 'サイドバーに戻す',
  floating: 'フローティングウィンドウ',
  floatingGrip: '⠿ ドラッグで移動、右下でサイズ変更',
  gotoLinePrompt: '指定行へ移動：',
  moveSide: 'ドッキング位置を切り替える',
  outline: 'アウトライン',
  outlineEmpty: 'このファイルに表示できるシンボルはありません',
  settingsEditorAutoSaveDesc: '設定値：off（Ctrl+S の手動のみ）、onBlur（エディターがフォーカスを失ったときに保存）、afterDelay（入力停止から約 1 秒後に保存）',
  settingsEditorAutoSavePlaceholder: 'off / onBlur / afterDelay',
  settingsEditorAutoSaveTitle: '自動保存',
  settingsEditorFontFamilyDesc: 'エディターのフォントファミリーを指定する（CSS font-family。例："JetBrains Mono", monospace。空欄でテーマの等幅フォントに従う）',
  settingsEditorFontFamilyPlaceholder: '"JetBrains Mono", monospace',
  settingsEditorFontFamilyTitle: 'エディターのフォント',
  settingsEditorFontSizeDesc: 'エディターの文字サイズ（10–32、既定値 13）',
  settingsEditorFontSizeSuffix: 'px',
  settingsEditorFontSizeTitle: 'エディターの文字サイズ',
  settingsEditorLineNumbersDesc: 'エディター左側に行番号の余白を表示する（既定でオン）',
  settingsEditorLineNumbersTitle: '行番号を表示する',
  settingsEditorTabSizeDesc: 'エディターで Tab キーが挿入するスペース数（2–8、既定値 4）',
  settingsEditorTabSizeSuffix: 'スペース',
  settingsEditorTabSizeTitle: 'タブ幅',
  settingsEditorWordWrapDesc: 'エディター幅を超える長い行を折り返して表示する（既定でオン）',
  settingsEditorWordWrapTitle: '折り返し',
}
