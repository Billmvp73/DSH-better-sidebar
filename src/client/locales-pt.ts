export const pt: Record<string, string> = {
  ...
  aiComplete: 'Conclusão por IA',
  aiDefaultInstruction: 'Completar este código',
  aiInsert: 'Inserir',
  aiInstructionPlaceholder: 'Digite uma instrução (ex.: completar / explicar / refatorar)',
  aiPlaceholder: 'Completar / continuar / explicar este código',
  aiReplace: 'Substituir',
  aiRun: 'Gerar',
  aiRunning: 'Gerando…',
  dock: 'Encaixar de volta na barra lateral',
  floating: 'Janela flutuante',
  floatingGrip: '⠿ arraste para mover, redimensione pelo canto',
  gotoLinePrompt: 'Ir para a linha:',
  moveSide: 'Alternar o lado de encaixe',
  outline: 'Estrutura',
  outlineEmpty: 'Nenhum símbolo neste arquivo',
  settingsEditorAutoSaveDesc: 'Valores: off (apenas Ctrl+S manual), onBlur (salvar quando o editor perder o foco), afterDelay (salvar cerca de 1 s após parar de digitar)',
  settingsEditorAutoSavePlaceholder: 'off / onBlur / afterDelay',
  settingsEditorAutoSaveTitle: 'Salvamento automático',
  settingsEditorFontFamilyDesc: 'Família de fontes personalizada do editor (pilha CSS font-family como "JetBrains Mono", monospace; deixe vazio para seguir a fonte monoespaçada do tema)',
  settingsEditorFontFamilyPlaceholder: '"JetBrains Mono", monospace',
  settingsEditorFontFamilyTitle: 'Fonte do editor',
  settingsEditorFontSizeDesc: 'Tamanho da fonte do editor em px (10–32, padrão 13)',
  settingsEditorFontSizeSuffix: 'px',
  settingsEditorFontSizeTitle: 'Tamanho da fonte do editor',
  settingsEditorLineNumbersDesc: 'Mostrar a régua de números de linha à esquerda do editor (ativado por padrão)',
  settingsEditorLineNumbersTitle: 'Mostrar números de linha',
  settingsEditorTabSizeDesc: 'Número de espaços que a tecla Tab insere no editor (2–8, padrão 4)',
  settingsEditorTabSizeSuffix: 'espaços',
  settingsEditorTabSizeTitle: 'Largura da tabulação',
  settingsEditorWordWrapDesc: 'Quebrar linhas longas que excedam a largura do editor (ativado por padrão)',
  settingsEditorWordWrapTitle: 'Quebra de linha',
}
