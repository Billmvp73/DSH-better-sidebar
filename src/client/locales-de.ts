...
export const de: Record<string, string> = {
  ...
  aiDefaultInstruction: 'Diesen Code vervollständigen',
  aiInsert: 'Einfügen',
  aiInstructionPlaceholder: 'Anweisung eingeben (z. B. vervollständigen / erklären / refaktorieren)',
  aiPlaceholder: 'Diesen Code vervollständigen / fortsetzen / erklären',
  aiReplace: 'Ersetzen',
  aiRun: 'Generieren',
  aiRunning: 'Wird generiert…',
  dock: 'Zurück an die Seitenleiste andocken',
  floating: 'Schwebendes Fenster',
  floatingGrip: '⠿ Ziehen zum Verschieben, Größe an der Ecke ändern',
  gotoLinePrompt: 'Gehe zu Zeile:',
  moveSide: 'Andockseite wechseln',
  outline: 'Gliederung',
  outlineEmpty: 'Keine Symbole in dieser Datei',
  settingsEditorAutoSaveDesc: 'Werte: off (nur manuell mit Strg+S), onBlur (speichern, wenn der Editor den Fokus verliert), afterDelay (ca. 1 s nach der letzten Eingabe speichern)',
  settingsEditorAutoSavePlaceholder: 'off / onBlur / afterDelay',
  settingsEditorAutoSaveTitle: 'Automatisch speichern',
  settingsEditorFontFamilyDesc: 'Eigene Schriftfamilie des Editors (CSS-font-family-Stack wie "JetBrains Mono", monospace; leer lassen, um der Monospace-Schrift des Themes zu folgen)',
  settingsEditorFontFamilyPlaceholder: '"JetBrains Mono", monospace',
  settingsEditorFontFamilyTitle: 'Editor-Schriftart',
  settingsEditorFontSizeDesc: 'Schriftgröße des Editors in px (10–32, Standard 13)',
  settingsEditorFontSizeSuffix: 'px',
  settingsEditorFontSizeTitle: 'Editor-Schriftgröße',
  settingsEditorLineNumbersDesc: 'Zeilennummernleiste links im Editor anzeigen (standardmäßig aktiviert)',
  settingsEditorLineNumbersTitle: 'Zeilennummern anzeigen',
  settingsEditorTabSizeDesc: 'Anzahl der Leerzeichen, die die Tabulatortaste im Editor einfügt (2–8, Standard 4)',
  settingsEditorTabSizeSuffix: 'Leerzeichen',
  settingsEditorTabSizeTitle: 'Tabulatorbreite',
  settingsEditorWordWrapDesc: 'Lange Zeilen umbrechen, die über die Editorbreite hinausgehen (standardmäßig aktiviert)',
  settingsEditorWordWrapTitle: 'Zeilenumbruch',
}
