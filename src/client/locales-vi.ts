...
export const vi: Record<string, string> = {
  ...
  aiComplete: 'Hoàn thành bằng AI',
  aiDefaultInstruction: 'Hoàn thành đoạn mã này',
  aiInsert: 'Chèn',
  aiInstructionPlaceholder: 'Nhập chỉ dẫn (vd: hoàn thành / giải thích / tái cấu trúc)',
  aiPlaceholder: 'Hoàn thành / viết tiếp / giải thích đoạn mã này',
  aiReplace: 'Thay thế',
  aiRun: 'Tạo',
  aiRunning: 'Đang tạo…',
  dock: 'Gắn lại vào thanh bên',
  floating: 'Cửa sổ nổi',
  floatingGrip: '⠿ kéo để di chuyển, đổi kích thước ở góc',
  gotoLinePrompt: 'Đi tới dòng:',
  moveSide: 'Đổi bên gắn',
  outline: 'Dàn ý',
  outlineEmpty: 'Không có ký hiệu nào trong tệp này',
  settingsEditorAutoSaveDesc: 'Giá trị: off (chỉ lưu thủ công bằng Ctrl+S), onBlur (lưu khi trình soạn thảo mất tiêu điểm), afterDelay (lưu khoảng 1 giây sau khi ngừng gõ)',
  settingsEditorAutoSavePlaceholder: 'off / onBlur / afterDelay',
  settingsEditorAutoSaveTitle: 'Tự động lưu',
  settingsEditorFontFamilyDesc: 'Bộ phông tùy chỉnh của trình soạn thảo (chuỗi CSS font-family như "JetBrains Mono", monospace; để trống để theo phông đơn cách của giao diện)',
  settingsEditorFontFamilyPlaceholder: '"JetBrains Mono", monospace',
  settingsEditorFontFamilyTitle: 'Phông chữ trình soạn thảo',
  settingsEditorFontSizeDesc: 'Cỡ chữ của trình soạn thảo tính bằng px (10–32, mặc định 13)',
  settingsEditorFontSizeSuffix: 'px',
  settingsEditorFontSizeTitle: 'Cỡ chữ trình soạn thảo',
  settingsEditorLineNumbersDesc: 'Hiện cột số dòng ở bên trái trình soạn thảo (bật theo mặc định)',
  settingsEditorLineNumbersTitle: 'Hiện số dòng',
  settingsEditorTabSizeDesc: 'Số khoảng trắng phím Tab chèn vào trình soạn thảo (2–8, mặc định 4)',
  settingsEditorTabSizeSuffix: 'khoảng trắng',
  settingsEditorTabSizeTitle: 'Độ rộng Tab',
  settingsEditorWordWrapDesc: 'Ngắt những dòng dài vượt quá chiều rộng trình soạn thảo (bật theo mặc định)',
  settingsEditorWordWrapTitle: 'Ngắt dòng',
}
