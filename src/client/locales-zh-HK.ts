...
export const zhHK: Record<string, string> = {
  ...
  aiComplete: 'AI 補全',
  aiDefaultInstruction: '補全這段程式碼',
  aiInsert: '插入',
  aiInstructionPlaceholder: '輸入指令，如：補全 / 解釋 / 重構這段程式碼',
  aiPlaceholder: '補全 / 續寫 / 解釋這段程式碼',
  aiReplace: '取代',
  aiRun: '產生',
  aiRunning: '產生中…',
  dock: '停靠回側邊欄',
  floating: '浮動視窗',
  floatingGrip: '⠿ 拖曳移動，右下角調整大小',
  gotoLinePrompt: '跳至行號：',
  moveSide: '切換停靠側',
  outline: '大綱',
  outlineEmpty: '此檔案沒有可顯示的符號',
  settingsEditorAutoSaveDesc: '可選值：off（僅手動 Ctrl+S）、onBlur（編輯器失去焦點時儲存）、afterDelay（停止輸入約 1 秒後儲存）',
  settingsEditorAutoSavePlaceholder: 'off / onBlur / afterDelay',
  settingsEditorAutoSaveTitle: '自動儲存',
  settingsEditorFontFamilyDesc: '自訂編輯器字型系列（CSS font-family，如 "JetBrains Mono", monospace；留空則跟隨主題等寬字型）',
  settingsEditorFontFamilyPlaceholder: '"JetBrains Mono", monospace',
  settingsEditorFontFamilyTitle: '編輯器字型',
  settingsEditorFontSizeDesc: '編輯器字級（10–32，預設 13）',
  settingsEditorFontSizeSuffix: 'px',
  settingsEditorFontSizeTitle: '編輯器字級',
  settingsEditorLineNumbersDesc: '在編輯器左側顯示行號欄（預設開啟）',
  settingsEditorLineNumbersTitle: '顯示行號',
  settingsEditorTabSizeDesc: '編輯器 Tab 鍵縮排的空格數（2–8，預設 4）',
  settingsEditorTabSizeSuffix: '空格',
  settingsEditorTabSizeTitle: 'Tab 寬度',
  settingsEditorWordWrapDesc: '開啟後，超出編輯器寬度的長行會自動換行顯示（預設開啟）',
  settingsEditorWordWrapTitle: '自動換行',
}
