...
export const th: Record<string, string> = {
  ...
  aiComplete: 'เติมโค้ดด้วย AI',
  aiDefaultInstruction: 'เติมโค้ดนี้ให้สมบูรณ์',
  aiInsert: 'แทรก',
  aiInstructionPlaceholder: 'พิมพ์คำสั่ง (เช่น เติม / อธิบาย / ปรับโครงสร้าง)',
  aiPlaceholder: 'เติม / เขียนต่อ / อธิบายโค้ดนี้',
  aiReplace: 'แทนที่',
  aiRun: 'สร้าง',
  aiRunning: 'กำลังสร้าง…',
  dock: 'ผนึกกลับเข้าแถบด้านข้าง',
  floating: 'หน้าต่างลอย',
  floatingGrip: '⠿ ลากเพื่อย้าย ปรับขนาดที่มุม',
  gotoLinePrompt: 'ไปยังบรรทัด:',
  moveSide: 'สลับด้านที่ผนึก',
  outline: 'เค้าโครง',
  outlineEmpty: 'ไม่มีสัญลักษณ์ในไฟล์นี้',
  settingsEditorAutoSaveDesc: 'ค่า: off (บันทึกเองด้วย Ctrl+S เท่านั้น), onBlur (บันทึกเมื่อตัวแก้ไขเสียโฟกัส), afterDelay (บันทึกราว 1 วินาทีหลังหยุดพิมพ์)',
  settingsEditorAutoSavePlaceholder: 'off / onBlur / afterDelay',
  settingsEditorAutoSaveTitle: 'บันทึกอัตโนมัติ',
  settingsEditorFontFamilyDesc: 'กำหนดตระกูลแบบอักษรของตัวแก้ไขเอง (CSS font-family เช่น "JetBrains Mono", monospace; เว้นว่างเพื่อใช้แบบอักษรความกว้างคงที่ของธีม)',
  settingsEditorFontFamilyPlaceholder: '"JetBrains Mono", monospace',
  settingsEditorFontFamilyTitle: 'แบบอักษรของตัวแก้ไข',
  settingsEditorFontSizeDesc: 'ขนาดอักษรของตัวแก้ไขเป็น px (10–32, ค่าเริ่มต้น 13)',
  settingsEditorFontSizeSuffix: 'px',
  settingsEditorFontSizeTitle: 'ขนาดอักษรของตัวแก้ไข',
  settingsEditorLineNumbersDesc: 'แสดงแถบหมายเลขบรรทัดทางซ้ายของตัวแก้ไข (เปิดตามค่าเริ่มต้น)',
  settingsEditorLineNumbersTitle: 'แสดงหมายเลขบรรทัด',
  settingsEditorTabSizeDesc: 'จำนวนช่องว่างที่ปุ่ม Tab แทรกในตัวแก้ไข (2–8, ค่าเริ่มต้น 4)',
  settingsEditorTabSizeSuffix: 'ช่องว่าง',
  settingsEditorTabSizeTitle: 'ความกว้าง Tab',
  settingsEditorWordWrapDesc: 'ตัดบรรทัดยาวที่เกินความกว้างของตัวแก้ไข (เปิดตามค่าเริ่มต้น)',
  settingsEditorWordWrapTitle: 'ตัดบรรทัดอัตโนมัติ',
}
