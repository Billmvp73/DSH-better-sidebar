...
export const pl: Record<string, string> = {
  ...
  aiComplete: 'Uzupełnianie AI',
  aiDefaultInstruction: 'Uzupełnij ten kod',
  aiInsert: 'Wstaw',
  aiInstructionPlaceholder: 'Wpisz polecenie (np. uzupełnij / wyjaśnij / zrefaktoryzuj)',
  aiPlaceholder: 'Uzupełnij / kontynuuj / wyjaśnij ten kod',
  aiReplace: 'Zamień',
  aiRun: 'Generuj',
  aiRunning: 'Generowanie…',
  dock: 'Zadokuj z powrotem do paska bocznego',
  floating: 'Okno pływające',
  floatingGrip: '⠿ przeciągnij, aby przesunąć; rozmiar zmienisz w rogu',
  gotoLinePrompt: 'Przejdź do wiersza:',
  moveSide: 'Zmień stronę dokowania',
  outline: 'Konspekt',
  outlineEmpty: 'Brak symboli w tym pliku',
  settingsEditorAutoSaveDesc: 'Wartości: off (tylko ręcznie przez Ctrl+S), onBlur (zapis po utracie fokusu przez edytor), afterDelay (zapis około 1 s po zakończeniu pisania)',
  settingsEditorAutoSavePlaceholder: 'off / onBlur / afterDelay',
  settingsEditorAutoSaveTitle: 'Autozapis',
  settingsEditorFontFamilyDesc: 'Własna rodzina czcionek edytora (stos CSS font-family, np. "JetBrains Mono", monospace; puste — czcionka o stałej szerokości z motywu)',
  settingsEditorFontFamilyPlaceholder: '"JetBrains Mono", monospace',
  settingsEditorFontFamilyTitle: 'Czcionka edytora',
  settingsEditorFontSizeDesc: 'Rozmiar czcionki edytora w px (10–32, domyślnie 13)',
  settingsEditorFontSizeSuffix: 'px',
  settingsEditorFontSizeTitle: 'Rozmiar czcionki edytora',
  settingsEditorLineNumbersDesc: 'Pokaż pasek numerów wierszy po lewej stronie edytora (domyślnie włączone)',
  settingsEditorLineNumbersTitle: 'Pokaż numery wierszy',
  settingsEditorTabSizeDesc: 'Liczba spacji wstawianych klawiszem Tab w edytorze (2–8, domyślnie 4)',
  settingsEditorTabSizeSuffix: 'spacji',
  settingsEditorTabSizeTitle: 'Szerokość tabulacji',
  settingsEditorWordWrapDesc: 'Zawijaj długie wiersze wykraczające poza szerokość edytora (domyślnie włączone)',
  settingsEditorWordWrapTitle: 'Zawijanie wierszy',
}
