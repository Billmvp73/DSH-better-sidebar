...
export const id: Record<string, string> = {
  ...
  aiComplete: 'Pelengkapan AI',
  aiDefaultInstruction: 'Lengkapi kode ini',
  aiInsert: 'Sisipkan',
  aiInstructionPlaceholder: 'Ketik instruksi (mis. lengkapi / jelaskan / refaktor)',
  aiPlaceholder: 'Lengkapi / lanjutkan / jelaskan kode ini',
  aiReplace: 'Ganti',
  aiRun: 'Hasilkan',
  aiRunning: 'Menghasilkan…',
  dock: 'Tambatkan kembali ke bilah sisi',
  floating: 'Jendela mengambang',
  floatingGrip: '⠿ seret untuk memindahkan, ubah ukuran dari sudut',
  gotoLinePrompt: 'Ke baris:',
  moveSide: 'Ganti sisi tambatan',
  outline: 'Kerangka',
  outlineEmpty: 'Tidak ada simbol di berkas ini',
  settingsEditorAutoSaveDesc: 'Nilai: off (hanya manual dengan Ctrl+S), onBlur (simpan saat editor kehilangan fokus), afterDelay (simpan sekitar 1 detik setelah berhenti mengetik)',
  settingsEditorAutoSavePlaceholder: 'off / onBlur / afterDelay',
  settingsEditorAutoSaveTitle: 'Simpan otomatis',
  settingsEditorFontFamilyDesc: 'Keluarga fon khusus editor (tumpukan CSS font-family seperti "JetBrains Mono", monospace; kosongkan untuk mengikuti fon monospace tema)',
  settingsEditorFontFamilyPlaceholder: '"JetBrains Mono", monospace',
  settingsEditorFontFamilyTitle: 'Fon editor',
  settingsEditorFontSizeDesc: 'Ukuran fon editor dalam px (10–32, bawaan 13)',
  settingsEditorFontSizeSuffix: 'px',
  settingsEditorFontSizeTitle: 'Ukuran fon editor',
  settingsEditorLineNumbersDesc: 'Tampilkan bilah nomor baris di kiri editor (aktif secara bawaan)',
  settingsEditorLineNumbersTitle: 'Tampilkan nomor baris',
  settingsEditorTabSizeDesc: 'Jumlah spasi yang disisipkan tombol Tab di editor (2–8, bawaan 4)',
  settingsEditorTabSizeSuffix: 'spasi',
  settingsEditorTabSizeTitle: 'Lebar Tab',
  settingsEditorWordWrapDesc: 'Bungkus baris panjang yang melebihi lebar editor (aktif secara bawaan)',
  settingsEditorWordWrapTitle: 'Bungkus baris',
}
